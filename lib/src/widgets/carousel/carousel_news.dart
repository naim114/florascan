...
List<News?> newsList = [
  News(
    ...
    imgURL: 'https://dummyimage.com/1280x1000/00ff44/fff.png&text=example1',
    createdAt: DateTime.now().subtract(const Duration(days: 1)),
  ),
  News(
    title: 'Latest Update 2',
    imgURL: 'https://dummyimage.com/1280x1000/00ff44/fff.png&text=example2',
    createdAt: DateTime.now().subtract(const Duration(days: 2)),
  ),
  News(
    title: 'Important Announcement 3',
    imgURL: 'https://dummyimage.com/1280x1000/00ff44/fff.png&text=example3',
